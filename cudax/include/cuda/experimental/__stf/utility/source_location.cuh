...
//#if (CUDA_VERSION < 12050) // && defined(_CCCL_COMPILER_MSVC)
#define _CCCL_FORCE_SOURCE_LOCATION_FALLBACK 1
//#endif

// GCC11 provides non constexpr builtins
#if !defined(_CCCL_FORCE_SOURCE_LOCATION_FALLBACK) && defined(__cpp_lib_source_location) && (!defined(_CCCL_COMPILER_GCC) || _CCCL_GCC_VERSION >= 120000)
...
#elif !defined(_CCCL_FORCE_SOURCE_LOCATION_FALLBACK) && __has_include(<experimental/source_location>)
