...
typedef struct cccl_device_generate_build_result_t
{
  int cc;
  void* cubin;
  size_t cubin_size;
...
} cccl_device_generate_build_result_t;

CCCL_C_API CUresult cccl_device_generate_build(
...
CCCL_C_API CUresult cccl_device_generate_build_ex(
  cccl_device_generate_build_result_t* build,
  cccl_iterator_t d_out,
  cccl_op_t op,
  int cc_major,
